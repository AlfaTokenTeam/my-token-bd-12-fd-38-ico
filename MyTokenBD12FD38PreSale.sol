...
import "./MyTokenBD12FD38.sol";

contract MyTokenBD12FD38PreSale {
    MyTokenBD12FD38 public token;
    ...
    function MyTokenBD12FD38PreSale(
        MyTokenBD12FD38 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenBD12FD38(_token);
